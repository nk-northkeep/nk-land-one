...
graph TD
    ...
    B --> C[Problemas Comerciais]
    C --> D[Solução 4 Frentes]
    D --> E[Arquitetura Tríade]
    E --> F[Detalhes Técnicos]
    F --> G[Roadmap Resultados]
    G --> H[Provas Sociais]
    H --> I[Diagnóstico Interativo]
    I --> J[Conversão WhatsApp]
